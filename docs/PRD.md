...
**Author:** klos + Cursor
**Date:** 2026-05-20
**Status:** Working product spec. Implemented history lives in [`SHIPPED.md`](SHIPPED.md); docs routing lives in [`docs/README.md`](README.md).
...
[`SHIPPED.md`](SHIPPED.md); load that file by anchor only. Each planned
...
| Range | Scope | History |
| --- | --- | --- |
| **M0 → M8.1** | Workspace, audio engine, transport, timecode, external routing, Thru, BPM. | [`SHIPPED.md`](SHIPPED.md#m0) |
| **M9 → M10.8** | Live peaks, spectral extraction, Metal waveform, Apple shell, Performance/Prep mode, Panic Play, Phase-Drift Trail, waveform baseline reset. | [`SHIPPED.md`](SHIPPED.md#m9) |
| **M11a → M11d.4** | Library schema, fingerprint dedupe, filesystem importer, browser shell, smart crates, indicators, scanner, Relocate. | [`SHIPPED.md`](SHIPPED.md#m11a) |
| **M11c.1 → M11c.2** | Lazy auto beat-grid analysis and Camelot key detection. | [`SHIPPED.md`](SHIPPED.md#m11c1) |
| **M11c.3a** | BPM octave fix (perceptual tempo prior — rap at 95, DnB at 172). | [`SHIPPED.md`](SHIPPED.md#m11c3a) |
| **M11c.3c** | Reggae skank double-time rejection (Default profile pass 2). | [`SHIPPED.md`](SHIPPED.md#m11c3c) |
| **M11c.3d** | Genre-aware octave profile for library analysis (ID3 → `OctaveProfile`). | [`SHIPPED.md`](SHIPPED.md#m11c3d) |
| **M11c.3e** | Hip-hop double-time rejection (rap corpus 19/19 on Default). | [`SHIPPED.md`](SHIPPED.md#m11c3e) |
| **M11c.3f** | FourOnFloor profile + Dub mid-band fix (house/dubstep library). | [`SHIPPED.md`](SHIPPED.md#m11c3f) |
...
*End of document. v0.1 pre-alpha working spec. For shipped implementation history, see [`SHIPPED.md`](SHIPPED.md); for docs routing, see [`docs/README.md`](README.md).*
