...
| --- | --- | --- | --- |
| **M11c.3** | **BPM octave fix + tap-to-grid** | Real hip-hop/rap catalogs analyze at the audible tempo (not 2×); user can tap `G` to set downbeat and re-fit grid per §8.3.1. | 3–4 days |
